...
puts "To change my name, enter a new one now. Press enter to keep my name betty."
STDOUT.flush
ALIAS = ask "> "
if ALIAS == ""
  ALIAS = "betty"
else
  @INSTALL_LOC = Dir.home + '/' + ALIAS + '/'
...
if CONTINUE == "" || CONTINUE == "y"
    ...
    print "Writing an alias called #{ALIAS} to " + SHELLRC + "\n"
    open(SHELLRC, 'a') do |f|
      f.puts "\n"
      f.puts "######## Generated by Betty's install script"
      f.puts "alias #{ALIAS}=\'#{ Dir.home }/betty/main.rb\'"
    end
    
    puts "add auto-complete by typing"
    puts "complete -C #{@INSTALL_LOC}autocomplete.rb #{ALIAS}"
